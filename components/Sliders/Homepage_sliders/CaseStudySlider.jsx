  ...
  return (
    <div className="w-full">
      ...
      <div className="flex gap-3 justify-end lg:mt-[-58px] mt-[-20px]">
        ...
        <button
          ref={nextRef}
          className="w-[48px] h-[48px] rounded-full bg-[#2655C4] text-white flex items-center justify-center hover:bg-[#1C3C90] transition"
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="14" viewBox="0 0 16 14" fill="none">
      ...
      >
        {slides.map((slide, index) => (
          <SwiperSlide key={index}>
            <div className="w-full bg-[#071937] text-white rounded-[3px] overflow-hidden grid grid-cols-1 md:grid-cols-[60%_40%] mt-12">
              ...
              <div className="flex items-center justify-end p-4">
                <div className="w-full h-[250px] md:w-full md:h-[370px] lg:w-[370px] lg:h-[370px] overflow-hidden rounded-[3px] bg-white">
                  <img
                    src={slide.cs_image}
