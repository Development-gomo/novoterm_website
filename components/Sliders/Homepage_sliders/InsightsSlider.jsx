...
export default function InsightsSlider({ slides }) {
  ...
  return (
    <div className="relative w-full mt-12 min-h-[420px]">
      <Swiper
      ...
      <div className="flex gap-3 absolute right-0 top-[-96px] z-10 pointer-events-auto">
        <button ref={prevRef} className="swiper-prev w-[40px] h-[40px] rounded-full bg-[#BBC8E1] flex items-center justify-center text-[#1B3A6F] hover:bg-[#2655c4] cursor-pointer hover:text-white transition">
        ...
        <button ref={nextRef} className="swiper-next w-[40px] h-[40px] rounded-full cursor-pointer bg-[#2655c4] flex items-center justify-center text-white hover:bg-[#1B3A6F] transition">
          <svg xmlns="http://www.w3.org/2000/svg" width="23" height="15" viewBox="0 0 23 15" fill="none">
