  ...
  return (
    <div className="w-full">
      ...
      <div className="flex gap-6 justify-end mb-[40px]">
        <button ref={prevRef} className="w-[48px] h-[48px] rounded-full bg-[#BBC8E1] flex items-center justify-center hover:bg-[#2655C4] transition">
        ...
        <button ref={nextRef} className="w-[48px] h-[48px] rounded-full bg-[#2655C4] text-white flex items-center justify-center transition">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="14" viewBox="0 0 16 14" fill="none">
