...
export default function InnerHeroSection({ section, sectionId }) {
  ...
  return (
    ...
    >
      <HeroBackdrop media={background_image} objectPosition="object-center" />

      <div className="relative z-10 w-full web-width px-6 py-24 lg:py-36 lg:px-48 flex flex-col sm:block">
