...
export default function NewsletterSection({ section, sectionId, index = 0 }) {
      ...
      <div className="web-width mx-auto px-6 md:px-0">
        <div className="flex flex-col md:flex-row">
          ...
          <div className="md:w-[85%]">
            ...
            {subheading && (
              <p className={`text-[14px] sm:text-[16px] leading-[24px] max-w-[520px] mb-8 md:mb-10 ${isDark ? "text-white/85" : "text-[#061837]/85"}`}>
                {subheading}
              </p>
            )}
