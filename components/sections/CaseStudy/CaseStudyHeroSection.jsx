...
export default function CaseStudyHeroSection({ section, sectionId }) {
  ...
  return (
    <section
      id={sectionId}
      className="relative z-50 w-full min-h-screen flex items-center justify-center overflow-hidden"
    >
      ...
      />
      {/* CONTENT WRAPPER */}
      <div className="relative z-[2] web-width mx-auto px-6 md:px-0 flex flex-col sm:block">
        ...
        {heading && (
          <h1
            className="font-heading  font-semibold text-white [&_em]:italic [&_em]:font-serif [&_em]:normal-case
              ...
              w-full sm:w-[900px] mx-auto sm:mx-0 mb-1"
