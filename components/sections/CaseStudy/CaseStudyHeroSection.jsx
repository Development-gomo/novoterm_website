  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-[900px]">
        ...
        {heading && (
          <h1
            className="font-heading uppercase font-semibold text-white case-study-hero
              text-[36px] sm:text-[48px] md:text-[60px] lg:text-[80px]
              leading-tight md:leading-[90px] tracking-[1px] w-[900px]"
            dangerouslySetInnerHTML={{ __html: heading }}
          />
        )}

        {/* DESCRIPTION + CTA */}
        <div className="text-left max-w-[411px] mt-6 sm:mt-8 lg:mt-9 !justify-self-end">
