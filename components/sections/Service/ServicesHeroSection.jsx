...
>
      ...
      {/* CONTENT WRAPPER – SAME AS HOMEPAGE HERO */}
        ...
        {formattedHeading && (
          <h1
            className="font-heading uppercase font-semibold text-white
              ...
              leading-tight md:leading-[90px] tracking-[1px] w-[600px]"
            dangerouslySetInnerHTML={{ __html: formattedHeading }}
          />
        )}

        {/* BLOCK 2 – DESCRIPTION + CTA */}
        <div className="text-left max-w-[411px] mt-6 sm:mt-8 lg:mt-0 !justify-self-end">
