...
export function formatArticleDate(dateInput, lang = DEFAULT_LANG, options = {}) {
  if (!dateInput) return "";
  ...
  return lang === "sv" ? formattedDate.toLocaleLowerCase(locale) : sentenceCaseMonth(formattedDate, locale);
}
